...
|Configurada [MySQL](https://github.com/mysql) Database (can be changed)|
...
|CRUD (Create, Read, Update, Delete) Roles Management|
|CRUD (Create, Read, Update, Delete) Permission Management|
